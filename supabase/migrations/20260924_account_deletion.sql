-- Account deletion: ownership blockers + personal data cleanup RPC.
-- Auth user removal is performed by the delete-account Edge Function.
...
begin
  ...
  -- Personal posts authored as the user (not on behalf of a business entity).
  ...
  -- Anonymize encrypted messenger payloads instead of leaving identifiable content.
  ...
  -- Clear personal profile PII before auth deletion cascades the profile row.
