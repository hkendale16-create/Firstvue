-- Paste in Supabase SQL Editor (once). Same as
-- supabase/migrations/20260918_public_media_read.sql
--
-- Restores avatars, VUE photos, and post media after profile RLS tightening.
-- Safe to re-run. Does not open private message storage.
